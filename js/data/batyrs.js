...
export const BATYRS = [
  ...
  {
    id: "qobylandy",
    image: "assets/img/qobylandy.jpg",
    type: "epic",
    top: true,
    ...
    deeds: {
      ...
      ru: ["Победил Казан-хана в поединке", "Освободил свой народ из плена", "Вырастил из жеребёнка Тайбурыла легендарного тулпара"],
      en: ["Defeated Kazan Khan in single combat", "Freed his people from captivity", "Raised Taiburyl into a legendary steed"],
    },
    timeline: [
      { label: { kk: "Туылуы", ru: "Рождение", en: "Birth" }, text: { kk: "Тоқтарбай мен Аналықтың тілегі қабыл болады", ru: "Молитвы Токтарбая и Аналык услышаны", en: "Toktarbai and Analyk's prayers are answered" } },
      { label: { kk: "Құртқа", ru: "Куртка", en: "Kurtka" }, text: { kk: "Құртқаға үйленіп, Тайбурылды алады", ru: "Женится на Куртке и получает Тайбурыла", en: "Marries Kurtka and receives Taiburyl" } },
      { label: { kk: "Жорық", ru: "Поход", en: "Campaign" }, text: { kk: "Қазан ханның қамалына аттанады", ru: "Выступает против крепости Казан-хана", en: "Marches on Kazan Khan's fortress" } },
      { label: { kk: "Жеңіс", ru: "Победа", en: "Victory" }, text: { kk: "Елін азат етіп, еліне оралады", ru: "Освобождает народ и возвращается домой", en: "Frees his people and returns home" } },
    ],
    quote: {
      text: { kk: "Ел шетіне жау келсе, батырға тыныштық жоқ.", ru: "Когда враг у границ — батыру нет покоя.", en: "When the enemy nears the border, a batyr knows no rest." },
  ...
  },
  {
    ...
    deeds: {
      ...
      en: ["Rescued Gulbarshyn from her captors", "Survived seven years in a dungeon", "Punished Ultan and restored justice"],
    },
    timeline: [
      { label: { kk: "Уәде", ru: "Обет", en: "The vow" }, text: { kk: "Гүлбаршынға атастырылады", ru: "Помолвлен с Гулбаршын", en: "Betrothed to Gulbarshyn" } },
      { label: { kk: "Жорық", ru: "Поход", en: "Campaign" }, text: { kk: "Байшұбармен Тайшық ханға аттанады", ru: "На коне Байшубаре идёт к Тайшык-хану", en: "Rides Baishubar against Taishyk Khan" } },
      { label: { kk: "Зындан", ru: "Зиндан", en: "The pit" }, text: { kk: "Жеті жыл тұтқында", ru: "Семь лет в плену", en: "Seven years in captivity" } },
      { label: { kk: "Қайту", ru: "Возвращение", en: "Return" }, text: { kk: "Ұлтанды жеңіп, елін біріктіреді", ru: "Побеждает Ултана и объединяет род", en: "Defeats Ultan and reunites his people" } },
    ],
    quote: {
      text: { kk: "Зынданда жатса да, ердің рухы бос.", ru: "Даже в зиндане дух героя свободен.", en: "Even in the pit, a hero's spirit is free." },
      source: { kk: "Жыр мотиві", ru: "Мотив жыра", en: "Epic motif" },
    },
  ...
  {
    id: "er-targyn",
    image: "assets/img/er-targyn.jpg",
    type: "epic",
    top: true,
    ...
    deeds: {
      ...
      en: ["Crushed the enemies of Aksha Khan", "Chose freedom with Akzhunis", "Became friends with old Kozhak after their duel"],
    },
    timeline: [
      { label: { kk: "Қызмет", ru: "Служба", en: "Service" }, text: { kk: "Ақша ханның қолына қосылады", ru: "Вступает в войско Акша-хана", en: "Joins Aksha Khan's army" } },
      { label: { kk: "Шайқас", ru: "Битва", en: "Battle" }, text: { kk: "Жаудың қолын талқандайды", ru: "Громит вражеское войско", en: "Routs the enemy host" } },
      { label: { kk: "Ақжүніс", ru: "Акжунис", en: "Akzhunis" }, text: { kk: "Ханның қызымен бірге кетеді", ru: "Уходит вместе с дочерью хана", en: "Departs with the khan's daughter" } },
    ],
    quote: {
      text: { kk: "Құл болып тірі жүргенше, ер болып өлген артық.", ru: "Лучше пасть героем, чем жить рабом.", en: "Better to fall a hero than live a slave." },
      source: { kk: "Халық мақалы, жыр рухында", ru: "Народная пословица в духе жыра", en: "Folk proverb in the spirit of the epic" },
    },
    related: ["qobylandy", "qambar", "er-sayin"],
  },
  {
    id: "qambar",
    image: "assets/img/qambar.jpg",
    type: "epic",
    top: false,
    ...
    timeline: [
      { label: { kk: "Аңшы", ru: "Охотник", en: "Hunter" }, text: { kk: "Тоқсан үйлі елдің асыраушысы", ru: "Кормит девяносто юрт", en: "Feeds ninety households" } },
      { label: { kk: "Шапқыншылық", ru: "Набег", en: "The raid" }, text: { kk: "Жау Әзімбайдың еліне шабады", ru: "Враг нападает на аул Азимбая", en: "The enemy raids Azimbai's village" } },
      { label: { kk: "Жеңіс", ru: "Победа", en: "Victory" }, text: { kk: "Қамбар елді қорғап, Назымға қосылады", ru: "Камбар спасает народ и соединяется с Назым", en: "Qambar saves the people and weds Nazym" } },
    ],
    quote: {
      text: { kk: "Батырдың байлығы — елінің амандығы.", ru: "Богатство батыра — благополучие его народа.", en: "A batyr's wealth is the wellbeing of his people." },
      source: { kk: "Жыр мотиві", ru: "Мотив жыра", en: "Epic motif" },
    },
  ...
  },
  {
    ...
    deeds: {
      ...
      en: ["Rode out alone against the enemy in his youth", "Guarded the people's borders", "Fulfilled his parents' hopes"],
    },
    timeline: [
      { label: { kk: "Жастық", ru: "Юность", en: "Youth" }, text: { kk: "Ерте есейген батыр", ru: "Рано возмужавший батыр", en: "A batyr grown early" } },
      { label: { kk: "Аттану", ru: "Выступление", en: "Setting out" }, text: { kk: "Жалғыз жорыққа шығады", ru: "Выходит в одиночный поход", en: "Sets out on a lone campaign" } },
      { label: { kk: "Даңқ", ru: "Слава", en: "Glory" }, text: { kk: "Елге даңқымен оралады", ru: "Возвращается со славой", en: "Returns in glory" } },
    ],
    quote: {
      text: { kk: "Жастық — ерлікке кедергі емес.", ru: "Молодость — не помеха доблести.", en: "Youth is no barrier to valour." },
      source: { kk: "Жыр мотиві", ru: "Мотив жыра", en: "Epic motif" },
    },
  ...
  {
    id: "er-kokshe",
    image: "assets/img/er-kokshe.jpg",
    type: "epic",
    top: false,
    ...
    era: { kk: "Ноғайлы дәуірі", ru: "Эпоха Ногайлы", en: "Nogai era" },
    source: { kk: "«Ер Көкше» жыры, «Қырымның қырық батыры» циклі", ru: "Жыр «Ер Кокше», цикл «Сорок богатырей Крыма»", en: "The epic “Er Kokshe”, “Forty Batyrs of Crimea” cycle" },
    bio: {
    ...
    timeline: [
      { label: { kk: "Қолбасшы", ru: "Полководец", en: "Commander" }, text: { kk: "Ноғайлы қолын бастайды", ru: "Возглавляет ногайлинское войско", en: "Leads the Nogai host" } },
      { label: { kk: "Әке", ru: "Отец", en: "Father" }, text: { kk: "Ер Қосай дүниеге келеді", ru: "Рождается Ер Косай", en: "Er Kosai is born" } },
      { label: { kk: "Мұра", ru: "Наследие", en: "Legacy" }, text: { kk: "Ерлігі ұлында жалғасады", ru: "Подвиг продолжается в сыне", en: "His valour lives on in his son" } },
    ],
    quote: {
      text: { kk: "Әкенің ерлігі — ұлға мұра.", ru: "Доблесть отца — наследство сына.", en: "A father's valour is his son's inheritance." },
      source: { kk: "Жыр мотиві", ru: "Мотив жыра", en: "Epic motif" },
    },
  ...
  },
  {
    ...
    era: { kk: "Ноғайлы дәуірі", ru: "Эпоха Ногайлы", en: "Nogai era" },
    source: { kk: "«Қарасай–Қази» жыры, «Қырымның қырық батыры» циклі", ru: "Жыр «Карасай–Кази», цикл «Сорок богатырей Крыма»", en: "The epic “Qarasay–Qazi”, “Forty Batyrs of Crimea” cycle" },
    bio: {
    ...
    timeline: [
      { label: { kk: "Серт", ru: "Клятва", en: "The oath" }, text: { kk: "Қазимен дос болып серттеседі", ru: "Даёт клятву побратимства Кази", en: "Swears brotherhood with Qazi" } },
      { label: { kk: "Жорық", ru: "Поход", en: "Campaign" }, text: { kk: "Екі батыр бірге аттанады", ru: "Два батыра выступают вместе", en: "The two batyrs ride out together" } },
      { label: { kk: "Жеңіс", ru: "Победа", en: "Victory" }, text: { kk: "Жауды жеңіп, елге оралады", ru: "Побеждают врага и возвращаются", en: "Defeat the foe and return home" } },
    ],
    quote: {
      text: { kk: "Досың адал болса, жауың әлсіз.", ru: "Когда друг верен — враг бессилен.", en: "When your friend is true, your enemy is weak." },
      source: { kk: "Жыр мотиві", ru: "Мотив жыра", en: "Epic motif" },
    },
  ...
  /* ============================ ИСТОРИЧЕСКИЕ ============================ */
  {
    ...
    deeds: {
      kk: ["Аңырақай шайқасына қатысты", "Абылай ханның бас қолбасшыларының бірі болды", "Тарбағатай мен Жетісуды жоңғарлардан азат етті", "1750-жылдардағы шешуші жорықтарды басқарды"],
      ru: ["Участвовал в Анракайской битве", "Был одним из главных полководцев Абылай хана", "Освобождал Тарбагатай и Семиречье от джунгар", "Руководил решающими походами 1750-х годов"],
      en: ["Fought in the Battle of Anyrakay", "Served as one of Abylai Khan's chief commanders", "Liberated Tarbagatai and Zhetysu from the Dzungars", "Led decisive campaigns of the 1750s"],
    },
    timeline: [
      { year: "1691", text: { kk: "Дүниеге келді", ru: "Родился", en: "Born" } },
      { year: "1723", text: { kk: "«Ақтабан шұбырынды» — ұлы апат жылдары", ru: "«Годы великого бедствия» — Актабан шубырынды", en: "“Years of Great Disaster” — Aktaban shubyryndy" } },
      { year: "1729", text: { kk: "Аңырақай шайқасы", ru: "Анракайская битва", en: "Battle of Anyrakay" } },
      { year: "1750–1758", text: { kk: "Абылай ханмен бірге шешуші жорықтар", ru: "Решающие походы вместе с Абылай ханом", en: "Decisive campaigns with Abylai Khan" } },
      { year: "1769", text: { kk: "Дүниеден өтті", ru: "Скончался", en: "Died" } },
    ],
    quote: {
      text: { kk: "Жерің — анаң, оны жауға бермейді.", ru: "Земля — твоя мать, её не отдают врагу.", en: "Your land is your mother — you do not yield it to the enemy." },
  ...
  },
  {
    ...
    years: "1791–1838",
    era: { kk: "Бөкей ордасы, 1836–1838 көтерілісі", ru: "Букеевская орда, восстание 1836–1838", en: "Bukey Horde, uprising of 1836–1838" },
    bio: {
    ...
    deeds: {
      kk: ["Бөкей ордасындағы көтерілісті басқарды", "Шаруаларды жер тартып алуға қарсы біріктірді", "Махамбетпен бірге Хан ордасына жорық жасады"],
      ru: ["Возглавил восстание в Букеевской орде", "Объединил шаруа против изъятия земель", "Вместе с Махамбетом совершил поход на ханскую ставку"],
      en: ["Led the uprising in the Bukey Horde", "United herders against land seizures", "Marched on the khan's headquarters with Makhambet"],
    },
    timeline: [
      ...
      { year: "1837", text: { kk: "Хан ордасына жорық, Тастөбе шайқасы", ru: "Поход на ханскую ставку, бой у Тастобе", en: "March on the khan's seat, battle of Tastobe" } },
      { year: "1838", text: { kk: "12 шілде — Ақбұлақ шайқасында қаза тапты", ru: "12 июля — погиб в бою у Акбулака", en: "12 July — killed in battle at Akbulak" } },
    ],
    quote: {
      text: { kk: "Жер — халықтікі, оны сатуға ешкімнің қақысы жоқ.", ru: "Земля принадлежит народу, и никто не вправе её продавать.", en: "The land belongs to the people, and no one has the right to sell it." },
      source: { kk: "Халық аңызы бойынша", ru: "По народному преданию", en: "According to folk tradition" },
    },
  ...
  {
    id: "makhambet",
    image: "assets/img/makhambet.jpg",
    type: "historical",
    top: true,
    ...
    deeds: {
      kk: ["Исатаймен бірге көтерілісті басқарды", "Күрес рухындағы жырлар шығарды", "Көтеріліс жеңілгеннен кейін де күресін тоқтатпады"],
      ru: ["Возглавил восстание вместе с Исатаем", "Создал стихи, ставшие гимном борьбы", "Не прекратил борьбу после поражения"],
      en: ["Led the uprising together with Isatay", "Wrote verse that became the anthem of the struggle", "Kept fighting after the uprising's defeat"],
    },
    timeline: [
      { year: "1803", text: { kk: "Бөкей ордасында дүниеге келді", ru: "Родился в Букеевской орде", en: "Born in the Bukey Horde" } },
      { year: "1836", text: { kk: "Исатаймен бірге көтеріліске шықты", ru: "Вместе с Исатаем поднял восстание", en: "Rose up with Isatay" } },
      { year: "1838", text: { kk: "Исатай қаза тапқаннан кейін күресті жалғастырды", ru: "После гибели Исатая продолжил борьбу", en: "Continued the struggle after Isatay's death" } },
      { year: "1846", text: { kk: "20 қазан — қастандықпен өлтірілді", ru: "20 октября — убит наёмниками", en: "20 October — assassinated" } },
    ],
    quote: {
      text: {
      ...
      source: { kk: "Махамбет, «Ереуіл атқа ер салмай»", ru: "Махамбет, «Ереуіл атқа ер салмай»", en: "Makhambet, “Ereuil atqa er salmai”" },
    },
    related: ["isatay", "kabanbay", "er-targyn"],
  },
];

export const getBatyr = (id) => BATYRS.find((b) => b.id === id);
export const byType = (type) => BATYRS.filter((b) => b.type === type);
